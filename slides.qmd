...
:::{.incremental}
* Presentation slides ([bit.ly/2024-nicd-mlops](https://bit.ly/2024-nicd-mlops)).
...
* Best practices at every step of the chain

* All tools are opensource and free to install!
...
* Consider tools like {arrow} and Apache Spark for fast processing.
:::
:::

:::{.column width="40%"}
Parquet, arrow and Spark images here.
:::
:::
...
:::{.incremental}
* Your preferred MLOps platform probably has built-in tools for data wrangling!
* SageMaker:
...
:::{.column width="40%"}
H2O.ai and Autopilot logos here
:::
:::
...
```r
base_url = "127.0.0.1:8080/"  # Double-check 4-digit port number
...
* Vetiver for Python documentation:
:::
...
:::{.column width="40%"}
Docker logo or screenshot here
:::
:::
...
:::{.column width="40%"}
Images representing change and users
:::
:::
...
:::{.column width="40%"}
Image representing "drift" or divergence here
:::
:::
...
:::{.column width="40%"}
Represent digital twins and sensors here
:::
:::
