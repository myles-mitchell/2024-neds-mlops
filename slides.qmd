...
:::{.incremental}
* Store scoring metrics and model parameters of experiments.
...
Collate all the necessary info to store, deploy and version our model:
...
:::{.incremental}
* Try deploying locally to check that your model API works.
